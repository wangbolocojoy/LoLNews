package com.shop.newshop_application.views;
...
public class CustomTextview extends RelativeLayout implements View.OnTouchListener, ValueAnimator.AnimatorListener, ValueAnimator.AnimatorUpdateListener   {
    ...
    private void initViews(AttributeSet attrs) {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.item_car_number_add_sub_layout, this, true);
    ...
    static class UpdateRunnable implements Runnable {
        private WeakReference<CustomTextview> view;

        public UpdateRunnable(CustomTextview view) {
            this.view = new WeakReference<CustomTextview>(view);
        }

        public void run() {
            CustomTextview stepper = view.get();
            if (stepper != null) {
                stepper.updateUI();
            }
        }
