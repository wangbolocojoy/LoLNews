...
public class Home_Fragment_Item9_Adapter extends BaseQuickAdapter<Home_Json_Bean.DatasBean.bean8.GoodsBean5.ItemBean6,BaseViewHolder>{
    public Home_Fragment_Item9_Adapter(@Nullable List<Home_Json_Bean.DatasBean.bean8.GoodsBean5.ItemBean6> data) {
        super(R.layout.home_fragment_item1_adapter_item,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, final Home_Json_Bean.DatasBean.bean8.GoodsBean5.ItemBean6 item) {
