...
public class Home_Fragment_Item5_Adapter extends BaseQuickAdapter<Home_Json_Bean.DatasBean.bean4.GoodsBean1.ItemBean2,BaseViewHolder>{
    public Home_Fragment_Item5_Adapter(@Nullable List<Home_Json_Bean.DatasBean.bean4.GoodsBean1.ItemBean2> data) {
        super(R.layout.home_fragment_item1_adapter_item,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, final Home_Json_Bean.DatasBean.bean4.GoodsBean1.ItemBean2 item) {
