...
import com.shop.newshop_application.adapter.tabhomeitem.home.Home_Fragment_Item10_Adapter;
 ...
 */
public class Bean10ViewBinder extends ItemViewBinder<Home_Json_Bean.DatasBean.bean9.GoodsBean6, Bean10ViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Home_Json_Bean.DatasBean.bean9.GoodsBean6 bean9) {
        holder.textView.setText(bean9.getTitle()+"");
        holder.adapter.setNewData(bean9.getItem());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private Home_Fragment_Item10_Adapter adapter;

        ViewHolder(View itemView) {

            super(itemView);
            adapter=new Home_Fragment_Item10_Adapter(null);
