...
public class Home_Fragment_Item6_Adapter extends BaseQuickAdapter<Home_Json_Bean.DatasBean.bean5.GoodsBean2.ItemBean3,BaseViewHolder> {

    public Home_Fragment_Item6_Adapter(@Nullable List<Home_Json_Bean.DatasBean.bean5.GoodsBean2.ItemBean3> data) {
        super(R.layout.home_fragment_item1_adapter_item,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, final Home_Json_Bean.DatasBean.bean5.GoodsBean2.ItemBean3 item) {
