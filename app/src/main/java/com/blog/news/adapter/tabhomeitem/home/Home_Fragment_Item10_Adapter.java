...
public class Home_Fragment_Item10_Adapter extends BaseQuickAdapter<Home_Json_Bean.DatasBean.bean9.GoodsBean6.ItemBean7,BaseViewHolder>{
    public Home_Fragment_Item10_Adapter(@Nullable List<Home_Json_Bean.DatasBean.bean9.GoodsBean6.ItemBean7> data) {
        super(R.layout.home_fragment_item1_adapter_item,data);
    }

    @Override
    protected void convert(BaseViewHolder helper, final Home_Json_Bean.DatasBean.bean9.GoodsBean6.ItemBean7 item) {
