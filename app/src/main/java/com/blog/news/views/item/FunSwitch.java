package com.blog.news.views.item;
...
/**
 * Created by SuperDaHuiLang on 2018/2/26.
 */
public class FunSwitch extends View implements ValueAnimator.AnimatorUpdateListener,ValueAnimator.AnimatorListener,Checkable {
